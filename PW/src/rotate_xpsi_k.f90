...
!
! >>> This file is copied from rotate_wfc_k.f90,
! >>> and modified by Satomichi Nishihara
!
!----------------------------------------------------------------------------
SUBROUTINE rotate_xpsi_k( npwx, npw, nstart, nbnd, npol, psi, overlap, evc, hevc, sevc, e )
  !----------------------------------------------------------------------------
  !
  ...
  IF ( overlap ) THEN
     ...
     !
     CALL ZGEMM( 'C', 'N', nstart, nstart, kdim, ( 1.D0, 0.D0 ), psi, kdmx,  spsi, kdmx, ( 0.D0, 0.D0 ), sc, nstart )
     !
  ELSE
     !
  ...
  !
  IF ( overlap ) &
  CALL ZGEMM( 'N', 'N', kdim, nbnd, nstart, ( 1.D0, 0.D0 ), spsi, kdmx, vc, nstart, ( 0.D0, 0.D0 ), sevc, kdmx )
  !     
  DEALLOCATE( en )
  DEALLOCATE( vc )
  DEALLOCATE( sc )
...
!
!----------------------------------------------------------------------------
SUBROUTINE protate_xpsi_k( npwx, npw, nstart, nbnd, npol, psi, overlap, evc, hevc, sevc, e )
  !----------------------------------------------------------------------------
  !
