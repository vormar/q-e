...
!
  ...
  USE input_parameters,  ONLY:  title, calculation, restart_mode, prefix, pseudo_dir, outdir, tstress, tprnfor,       &
                                ...
                                diago_thr_init, diago_full_acc, diago_cg_maxiter, diago_david_ndim, diago_rmm_ndim,   &
                                diago_gs_nblock, nk1, nk2, nk3, k1, k2, k3, nkstot, ip_xk => xk, ip_wk => wk,         &
                                ...
                                with_sr1, cell_dynamics, wmass, cell_dofree, cell_factor,                             &
...
!
  ...
  CALL qexsd_init_electron_control(obj%electron_control, diagonalization, mixing_mode, mixing_beta, conv_thr,         &
                                   ...
                                   diago_full_acc, diago_cg_maxiter, diago_david_ndim, diago_rmm_ndim,                &
                                   diago_gs_nblock )
  !--------------------------------------------------------------------------------------------------------------------------------
